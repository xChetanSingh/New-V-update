...
def show_results(posts, start, end , sss):
    ...
    if results == []:
        ...
        reply = sss
        buttons = [[InlineKeyboardButton("👉 <b>HOW TO WATCH/DOWNLOAD</b>❓👈",url=howtodownload)],[InlineKeyboardButton("📲 Join Channel",url=channelurl),InlineKeyboardButton("🌐 Visit Web",url=web_domain)]]
        # print(posts)
